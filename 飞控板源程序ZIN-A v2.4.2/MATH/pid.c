...
/*                                         Kp        Ki        Kd            */
 ...
 {1  ,1 ,0 ,0 ,0 ,0 , 0 ,35,0  ,0 , 20,    5.6   ,0.0000  ,0.00 ,0  ,0 , 250},//Pitch_Angle;偏航角度
 {0  ,1 ,0 ,0 ,0 ,0 , 0 ,500 ,0  ,0 , 200,  0.65   ,0.0055  ,3.0  ,0  ,0 ,500},//Pitch_Gyro;偏航角速度
 {1  ,1 ,0 ,0 ,0 ,0 , 0 ,35  ,0  ,0 , 20,  5.6   ,0.0000  ,0.00 ,0  ,0 , 250},//Roll_Angle;横滚角
 {0  ,1 ,0 ,0 ,0 ,0 , 0 ,500 ,0  ,0 , 200,  0.65   ,0.0055  ,3.0  ,0  ,0 ,500},//Roll_Gyro;横滚角速度
 {1  ,1 ,0 ,0 ,0 ,0 , 0 ,35  ,0  ,0 , 0 ,   7.0   ,0       ,0.00  ,0  ,0 ,100},//Yaw_Angle;偏航角
...
#else
 //{1  ,1 ,0 ,0 ,0 ,0 , 0 ,200 ,0  ,0 ,100 ,  1.5     ,0.000   ,0    ,0  ,0 ,400},//High_Position;海拔高度位置
 //{1  ,1 ,0 ,0 ,0 ,0 , 0 ,400 ,0  ,0 ,500 ,  3.0     ,0.000   ,0    ,0  ,0 ,700},//High_Speed;海拔攀升速度
 {1  ,1 ,0 ,0 ,0 ,0 , 0 ,200 ,0  ,0 ,100 ,  2.3     ,0.0023   ,0.2    ,0  ,0 ,400},//High_Position;海拔高度位置
 {1  ,1 ,0 ,0 ,0 ,0 , 0 ,400 ,0  ,0 ,500 ,  0.4     ,0.000   ,0.1    ,0  ,0 ,700},//High_Speed;海拔攀升速度
#endif
 /*
1偏差限幅标志；  2积分限幅标志；3积分分离标志；   4期望；
5反馈            6偏差；        7上次偏差；       8偏差限幅值；
...
/*                                       Kp        Ki        Kd            */
 ...
 //{1  ,1 ,0 ,0 ,0 ,0 , 0 ,500  ,0  ,0 ,300, 0.32     ,0.005     ,0 ,0   ,0 ,500},//垂直加速度控制器
